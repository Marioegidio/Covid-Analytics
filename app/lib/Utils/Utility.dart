...
//   }
  ...
  static Future<String> fetchLikes() async {
    String url;
    url = 'https://vimae.altervista.org/cov_italia/covidItalia_getLikes.php';
  ...
  static Future<String> sendLike() async {
    String url;
    url = 'https://vimae.altervista.org/cov_italia/covidItalia_updateLikes.php';
    final response = await http.get(url);
  ...
  static sendReport(String versionCode, String versionName) async {
    String url =
        'https://vimae.altervista.org/cov_italia/covidItalia_access_registerPlayStore.php?cv=$versionCode&vn=$versionName';
    http.get(url);
  }
