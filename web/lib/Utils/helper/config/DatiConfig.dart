...
class DatiConfig {
  ...
  static void fromJson(Map<String, dynamic> array) {
    ...
    try {
      DatiConfig.URL_PROVINCE = "https://cors-anywhere.herokuapp.com/" +
          array["url_dati_province"].toString();
    } catch (e) {
      print("Errore url_dati_province");
    }

    try {
      DatiConfig.URL_REGIONI = "https://cors-anywhere.herokuapp.com/" +
          array["url_dati_regioni"].toString();
    } catch (e) {
      print("Errore url_dati_regioni");
    }

    try {
      DatiConfig.URL_NAZIONE = "https://cors-anywhere.herokuapp.com/" +
          array["url_dati_nazione"].toString();
    } catch (e) {
      print("Errore url_dati_nazione");
    }

    try {
      DatiConfig.VERSION_CODE = "https://cors-anywhere.herokuapp.com/" +
          array["app_version_code"].toString();
    } catch (e) {
    ...
    try {
      DatiConfig.URL_CODICI_NAZIONI = "https://cors-anywhere.herokuapp.com/" +
          array["url_codici_nazioni"].toString();
    } catch (e) {
